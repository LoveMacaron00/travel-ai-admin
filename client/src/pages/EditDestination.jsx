                            ...
                            <div>
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <label className="flex items-center gap-2 cursor-pointer group">
                                        <input 
                                            type="checkbox" 
                                            className="w-4 h-4 rounded bg-black/40 border border-gray-700 text-yellow-500 focus:ring-yellow-500 focus:ring-offset-gray-900" 
                                            checked={hasOpeningHours}
                                            onChange={(e) => setHasOpeningHours(e.target.checked)}
                                        />
                                        <span className="text-xs text-gray-400 group-hover:text-yellow-400 transition-colors">Specify hours</span>
                                    </label>
                                </div>
                                {hasOpeningHours ? (
                                    <div className="flex items-center gap-2">
                                        <input
                                            type="time"
                                            className="w-full bg-black/40 border border-gray-700 rounded-xl px-3 py-2.5 text-white focus:outline-none focus:ring-2 focus:ring-yellow-500/50"
