        ...
        const fetchDestination = async () => {
            try {
                ...
                setForm({
                    ...
                    sub_district_id: data.sub_district_id != null ? String(data.sub_district_id) : '',
                    ...
                    category: data.category === 'general' ? 'other' : data.category || 'attraction',
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.data?.warning) {
                ...
                await showSuccessAlert(response.data?.message || 'บันทึกการเปลี่ยนแปลงเรียบร้อยแล้ว');
            }
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-3 bg-gradient-to-r from-gray-900 to-gray-800 p-3 rounded-xl border border-gray-800 shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-2">
                        <span className="px-3 py-1 rounded-full bg-yellow-500/10 text-yellow-500 text-xs font-bold tracking-widest uppercase border border-yellow-500/20">โหมดแก้ไข</span>
                    </div>
                    <h1 className="text-xl md:text-2xl font-bold text-white tracking-tight">
                        แก้ไขสถานที่
                    </h1>
                    <p className="text-gray-400 mt-1 text-sm">
                        แก้ไขข้อมูล ตำแหน่ง และรูปภาพของสถานที่
                    </p>
                </div>
